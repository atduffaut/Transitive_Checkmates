...
ChessAdjGraph::ChessAdjGraph(QString filename)
{
...
vector<pair<string, int>> ChessAdjGraph::findTopN(string name, int n)
{
...
void ChessAdjGraph::findTopNHelper(string curr,
                                unsigned int n,
...
vector<vector<string>> ChessAdjGraph::findPath(string source, vector<string> dests)
{
